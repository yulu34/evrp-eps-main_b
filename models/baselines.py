...
class RolloutBaseline(Baseline):
    ...
    def _update_model(self, model, epoch):
        ...
        self.dataset = CIRPDataset().generate(num_samples=self.num_greedy_samples,
                                              ...
                                              # vehicle_discharge_rate=self.opts.vehicle_discharge_rate, #删除
                                              depot_discharge_rate=self.opts.depot_discharge_rate, #删除
                                              # discharge_lim_ratio=self.opts.discharge_lim_ratio, #删除 或者更改成电量下限
